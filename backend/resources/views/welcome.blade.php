...
<body class="antialiased bg-white text-slate-900 hero-pattern overflow-x-hidden" x-data="{ scrolled: false, mobileOpen: false }" @scroll.window="scrolled = window.scrollY > 50">
