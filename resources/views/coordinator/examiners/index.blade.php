...
<div x-data="{ showInternalModal: false, showExternalModal: false }" class="space-y-10 pb-10">
    ...
    <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6 pb-6 border-b border-slate-100">
        ...
        <div class="flex items-center gap-3">
            <button @click="showInternalModal = true" class="px-5 py-3 rounded-2xl bg-white text-slate-700 hover:text-acetel-600 hover:border-acetel-200 transition-all text-[10px] font-black uppercase tracking-widest border border-slate-200 shadow-sm flex items-center gap-2 group">
            ...
            <button @click="showExternalModal = true" class="px-5 py-3 rounded-2xl bg-slate-900 text-white hover:bg-acetel-600 transition-all text-[10px] font-black uppercase tracking-widest shadow-xl shadow-slate-900/10 flex items-center gap-2 group border border-slate-800 hover:border-acetel-500">
