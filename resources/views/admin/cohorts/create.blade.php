...
<div class="max-w-3xl mx-auto">
    <div class="md:flex md:items-center md:justify-between mb-8">
        <div class="flex-1 min-w-0">
            <h2 class="text-2xl font-extrabold leading-7 text-black sm:text-3xl sm:truncate">Create New Cohort</h2>
            <p class="mt-2 text-sm text-black">Define a new academic session or admission cycle.</p>
        </div>
            ...
            <form action="{{ route('admin.cohorts.store') }}" method="POST">
                ...
                <div class="grid grid-cols-6 gap-6">
                     <div class="col-span-6 sm:col-span-4">
                        ...
                        <input type="text" name="name" id="name" class="focus:ring-acetel-500 focus:border-acetel-500 block w-full shadow-sm sm:text-sm border-slate-300 rounded-xl px-4 py-2.5 transition-colors" value="{{ old('name') }}" placeholder="e.g. 2025/2026 Academic Session" required>
                    ...
                    <div class="col-span-6 sm:col-span-2">
                        ...
                        <input type="text" name="code" id="code" class="focus:ring-acetel-500 focus:border-acetel-500 block w-full shadow-sm sm:text-sm border-slate-300 rounded-xl px-4 py-2.5 transition-colors" value="{{ old('code') }}" placeholder="e.g. MSC_AI_2026" required>
                    ...
                    <div class="col-span-6 sm:col-span-2">
                        ...
                        <input type="number" name="intake_year" id="intake_year" min="2000" max="2100" class="focus:ring-acetel-500 focus:border-acetel-500 block w-full shadow-sm sm:text-sm border-slate-300 rounded-xl px-4 py-2.5 transition-colors" value="{{ old('intake_year') }}" placeholder="e.g. 2026">
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        <label for="status" class="block text-sm font-semibold text-black mb-1">Initial Status <span class="text-red-500">*</span></label>
                        ...
                        <p class="mt-1.5 text-xs text-black">Only Active cohorts appear during student registration and import.</p>
