...
<head>
    ...
    <title>{{ config('app.name', 'TMS Admin') }}</title>
...
<body class="font-sans antialiased text-slate-800 admin-main selection:bg-brand-200 selection:text-brand-800 h-full overflow-hidden">
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-72 light-sidebar transition-all duration-500 transform md:translate-x-0 md:relative flex flex-col group"
            ...
            <div class="flex items-center px-8 h-24 shrink-0 border-b border-green-100">
                <div class="flex items-center gap-4 cursor-pointer">
                    ...
                    <div>
                        <span class="block text-xl font-black tracking-tight text-slate-800 leading-none uppercase">CORE</span>
                        <span class="block text-[9px] font-bold text-green-600 uppercase tracking-[0.35em] mt-1">Strategic Admin</span>
                    </div>
                </div>
            </div>
