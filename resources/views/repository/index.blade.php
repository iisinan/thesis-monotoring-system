                ...
                <div class="item-content">
                    ...
                    <div class="item-actions mt-3" x-show="expanded" x-transition>
                        ...
                        @if($thesis->library_copy)
                            <a href="#" @click.prevent="pdfUrl = '{{ Storage::url($thesis->library_copy->file_url) }}'; pdfTitle = '{{ addslashes($thesis->title) }}'; showPdfModal = true" class="ml-4 flex items-center gap-1 text-[#dd4b39] font-bold">
                ...
                <div class="pdf-indicator hidden sm:block">
                    @if($thesis->library_copy)
                        <div class="pdf-link-wrapper">
                            ...
                            <a href="#" @click.prevent="pdfUrl = '{{ Storage::url($thesis->library_copy->file_url) }}'; pdfTitle = '{{ addslashes($thesis->title) }}'; showPdfModal = true" class="pdf-domain">acetel.edu.ng</a>
                        </div>
                    @endif
                </div>
            </div>
